...
def load_data(path: str):
    ...
    # Jeśli pierwsza kolumna to datetime, ustaw ją jako indeks (ale i tak używamy wartości)
    ...
    for folder, is_regression in DATASETS:
        ...
        for train_file, test_file, val_file in SPLITS:
            ...
            if is_regression:
                ...
                # Możesz tu zhardkodować 2, jeśli na pewno binary:
                # n_outputs = 2
                # albo dynamicznie po etykietach:
